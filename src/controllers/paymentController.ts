...
const generateEsewaSignature = (message: string, secret: string): string => {
...
export const verifyKhalti = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const khaltiData: any = await response.json();
...
export const initiateStoryKhalti = async (req: Request, res: Response) => {
...
export const verifyStoryKhalti = async (req: Request, res: Response) => {
    const { pidx } = req.body;
...
export const initiateStoryEsewa = async (req: Request, res: Response) => {
    const { story_id, price } = req.body;
    const user = req.user;
...
export const verifyStoryEsewa = async (req: Request, res: Response) => {
    const { encodedData } = req.body;
...
export const initiateSiteKhalti = async (req: Request, res: Response) => {
...
export const verifySiteKhalti = async (req: Request, res: Response) => {
    const { pidx } = req.body;
...
export const initiateSiteEsewa = async (req: Request, res: Response) => {
    const { site_id, price } = req.body;
    const user = req.user;
...
export const verifySiteEsewa = async (req: Request, res: Response) => {
    const { encodedData } = req.body;
