...
export const getStoryPreviewById = async (req: Request, res: Response) => {
...
export const getStoriesPreviewBySite = async (req: Request, res: Response) => {
...
export const getFullStory = async (req: Request, res: Response) => {
  const { story_id } = req.params;
