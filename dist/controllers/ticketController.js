...
export const verifyTicketQR = async (req, res) => {
    ...
    try {
        ...
        try {
            await createNotification(ticket.user_id, 'booking', 'Ticket Verified', `Your entry for ${ticket.museum.name} has been successfully scanned. Enjoy your visit!`, ticket.ticket_id);
        }
        catch (notifError) {
