...
export const addMuseum = async (req, res) => {
    const { name, location, description, opening_hours } = req.body;
    const file = req.file;
    ...
    if (!name || !location || !description || !opening_hours) {
        return res.status(400).json({
            message: 'Missing required fields: name, location, description, and opening_hours are required',
        });
    }
    try {
...
//# sourceMappingURL=museumController.js.map